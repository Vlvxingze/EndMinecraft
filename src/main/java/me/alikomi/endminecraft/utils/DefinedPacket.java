...
public abstract class DefinedPacket extends Util {

    public static void writeString(String s, ByteBuf buf) {
        if (s.length() > Short.MAX_VALUE) {
            log(String.format("Cannot send string longer than Short.MAX_VALUE (got %s characters)", s.length()));
        }
    ...
    public static String readString(ByteBuf buf) {
        ...
        if (len > Short.MAX_VALUE) {
            log(String.format("Cannot receive string longer than Short.MAX_VALUE (got %s characters)", len));
        }
